...
public class GameState {
    public enum State{
        TILE, EVENT, EVENTOUTCOME, ACTIONMENU, TRAVEL, CAMPING, MENU, GAMEOVER
    }
    private State state;
    ...
    public void outcomeConfirmed(){state = State.TRAVEL;}
    ...
    public int spawnResources(){
        int spawnResult = 0;
        if(gameMap.getCurrentTile().spawnResourceAttempt()){
            Random random = new Random();
