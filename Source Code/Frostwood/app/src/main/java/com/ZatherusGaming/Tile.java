...
public class Tile {
    ...
    public boolean spawnResourceAttempt(int perception){
        Random random = new Random();
        int randomRoll = random.nextInt(100) + 1;

        //Add 3% per point of perception to the chance of spawning to a max of 70.
        int adjustedChance = resourceSpawnChance + (perception * 3);
        if(adjustedChance > 70){
            adjustedChance = 70;
        }
