...
public class Player extends Actor{
    ...
    public final int ENDURANCE_PERCENT = 5;
    ...
    public void decreaseMana(int amount) {
        ...
        float percentBlocked = (endurance * ENDURANCE_PERCENT)/100;

        if(percentBlocked > 70){
            percentBlocked = 70;
        }

        int statAdjustedLoss = amount - (int)(amount*percentBlocked);

        currentMana -= statAdjustedLoss;
    ...
    public void decreaseStamina(int amount) {
        ...
        currentStamina -= statAdjustedLoss;
    ...
    public void decreaseMaxStamina(int amount){
        ...
        //Protect against a percentage of damage based on endurance.
        //5% per endurance up to a max of 70%
        float percentBlocked = (endurance * ENDURANCE_PERCENT)/100;
